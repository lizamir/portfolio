      ...
      <section className="links-card">
        <section className="flex">
          ...
          <section>
            <wired-icon-button
              onClick={() => {
                window.open('mailto:' + 'gali.nickel95@gmail.com', '_self');
              }}
            >
              {emailIcon}{' '}
            </wired-icon-button>
            <wired-icon-button
              onClick={() => {
                window.open('https://github.com/galinickel');
              }}
            >
              {githubIcon}
            </wired-icon-button>
            <wired-icon-button
              onClick={() => {
                window.open(
                  'https://www.linkedin.com/in/gali-nickel-b37b0020a/'
                );
              }}
            >
              {linkedInIcon}
            ...
            <wired-icon-button
              onClick={() => {
                window.location.assign(
                  'https://drive.google.com/uc?export=download&id=1wSwt5R6bZRcm9CgBXvUrUCpOy-VYgJ_r'
                );
              }}
            >
              {cvIcon}
